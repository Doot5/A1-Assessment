...
As for my Learning Style, the results show that I tend to be able to learn better when i'm doing a physical activity, so upon seeing something new I will write it down, set it up in an example website 
      <a href="https://www.w3schools.com/html/tryit.asp?filename=tryhtml_table">Tryit Editor<a>.
